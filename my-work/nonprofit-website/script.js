...
document.addEventListener("DOMContentLoaded", function() {
    /* 1. Toggle the menu slide in on menu icon click */
  ...
  function isImageInViewport(element) {
    ...
    return (
      ...
      el.bottom <= (window.innerHeight || document.documentElement.clientHeights)
    );
  }
  // On load
  ...
  function insertEcwidStore() {
    ...
    storeDiv.setAttribute("id", "my-store-103956461");
    ...
    scriptOne.src = "https://app.ecwid.com/script.js?103956461&data_platform=code&data_date=2024-05-14";
    var scriptTwo = document.createElement("script");
    scriptTwo.setAttribute("type", "text/javascript");
    scriptTwo.innerHTML = 'xProductBrowser("categoriesPerRow=3", "views=grid(20,3) list(60) table(60)", "categoryView=grid", "searchView=list", "id=my-store-103956461");';
